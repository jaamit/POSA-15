...
class RequestHandler extends Handler {
            ...
            new Runnable() {
                ...
                public void run() {
                	...
                	final Uri pathToImageFile = 
                			Utils.downloadImage(mService.get(), imageURL, directoryPathname);
                	
                    // Send the path to the image file, url, and
                    // requestCode back to the Activity via the
                    // replyMessenger.
                    // TODO -- DONE you fill in here.
                  	sendPath(replyMessenger, 
    ...
    public void sendPath(Messenger messenger, 
        ...
        // Message.
        // TODO -- DONE you fill in here.
    	ReplyMessage replyMessage = ReplyMessage.makeReplyMessage
    			                                (pathToImageFile,
    			                                 url,
    			                                 requestCode);
        try {
            ...
            // TODO -- DONE you fill in here.
            replyMessage.getMessenger().send(replyMessage.getMessage());
        } catch (Exception e) {
