...
public class DownloadImageService extends IntentService {
    ...
    public void onHandleIntent(Intent intent) {
    	...
    	final String directoryPathname = 
    			intent.getStringExtra(DIRECTORY_PATHNAME);

        // Download the requested image.
        // @@ TODO -- DONE you fill in here.
    	final Uri pathToImageFile = 
    			Utils.downloadImage(DownloadImageService.this, url, directoryPathname);
    ...
    private void sendPath(Messenger messenger, 
        ...
        // @@ TODO -- DONE you fill in here.
    	Message message =
    			makeReplyMessage(pathToImageFile, 
    					url,
    					requestCode);
        try {
            // Send the path to the image file back to the
        	...
        	Log.e(getClass().getName(),
        			"Exception while sending message back to Main Activity",
        			e);
        }
